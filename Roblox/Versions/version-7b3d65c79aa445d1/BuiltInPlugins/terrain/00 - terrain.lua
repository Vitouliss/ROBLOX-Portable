...
function onGenerate()
	...
	-- "bump" camera up to 200 studs if it was not before
	if game.Workspace.CurrentCamera.CoordinateFrame.p.Y < 200 then game.Workspace.CurrentCamera.CoordinateFrame = game.Workspace.CurrentCamera.CoordinateFrame + Vector3.new(0, 200 - game.Workspace.CurrentCamera.CoordinateFrame.p.Y, 0) end
